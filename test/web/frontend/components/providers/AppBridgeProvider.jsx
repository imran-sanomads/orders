...
export function AppBridgeProvider({ children }) {
  ...
  const [appBridgeConfig] = useState(() => {
    ...
    if (!host) {
      console.error("Invalid or missing 'host' parameter.");
      // Handle the error or fallback scenario here.
    }

    return {
      host,
      apiKey: '528cee816890107c1206101a2abf366a',
      forceRedirect: true,
    };
  });
  console.log("SHOPIFY_API_KEY:", '528cee816890107c1206101a2abf366a');

  if (!'528cee816890107c1206101a2abf366a' || !appBridgeConfig.host) {
    const bannerProps = !'528cee816890107c1206101a2abf366a'
      ? {
